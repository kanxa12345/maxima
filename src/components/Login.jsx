  ...
  return (
    <>
      ...
      >
        ...
        {/* login box */}
        <div
          className={`${activeBox === 0 ? "flex" : "hidden"} w-full flex-col`}
        >
          ...
          >
            ...
            <div className="w-full relative">
              <input
                ...
                className={`focus:outline-none w-full p-2 border border-gray-400 rounded placeholder:text-base placeholder:font-normal ${
                  !showLoginPassword ? "text-xl font-bold py-[6px]" : ""
                }`}
              />
            ...
            <a
              href="#"
              className="flex text-sm text-brandColor hover:underline"
            >
              Forgot password ?
            </a>
          </form>
        ...
        {/* signup box */}
        <div
          className={`${activeBox === 1 ? "flex" : "hidden"} w-full flex-col`}
        >
          <h2 className="lg:text-2xl text-xl font-medium sm:mb-4 mb-1 text-center">
            Signup to maxima
          </h2>
          ...
          >
            ...
            <div className="w-full relative">
              <input
                ...
                required
                className={`focus:outline-none w-full p-2 border border-gray-400 rounded placeholder:text-base placeholder:font-normal ${
                  !showSignupPassword ? "text-xl font-bold py-[6px]" : ""
                }`}
              />
            ...
            <div className="w-full relative">
              <input
                ...
                required
                className={`focus:outline-none w-full p-2 border border-gray-400 rounded placeholder:text-base placeholder:font-normal ${
                  !showReSignupPassword ? "text-xl font-bold py-[6px]" : ""
                }`}
              />
              {signUpForm.rePassword.length > 0 && (
                <span
