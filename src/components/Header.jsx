...
const Header = () => {
    ...
    return (
        <>
            ...
            <div className='bg-brandColor text-white relative z-10'>
                <div className="container flex items-center justify-between">
                    <div
                        ...
                        <span className='w-full bg-white text-black py-1 px-2 flex items-center justify-between rounded'>
                            Products
                            <i className={`fa-solid fa-angle-down text-sm ${categoryMenus['Products'] ? 'rotate-180' : ''} transition-all duration-200 ease-linear`}></i>
                        </span>
                            ...
                            <div className="flex flex-col lg:w-60 w-full h-full overflow-y-auto">
                                {Object.values(groupedData).map((categoryItem, categoryIndex) => (
                                    ...
                                    >
                                        ...
                                        <i className="fa-solid fa-angle-right text-sm text-gray-500 pr-[14px]"></i>
